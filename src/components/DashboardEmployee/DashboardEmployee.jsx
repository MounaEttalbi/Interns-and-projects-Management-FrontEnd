...
import { FaSearch, FaBell, FaPeopleCarry } from 'react-icons/fa';
...
const SidebarStag = ({ setActiveView, setShowLogoutConfirmation }) => {
  ...
  return (
    <div className='sideBar grid'>
      ...
      <div className='menuDiv'>
        ...
        <ul className='menuLists grid'>
          <li className='listItem'>
            <a href="#" className='menuLink flex'onClick={(e) => handleClick(e, 'Listing')}>
              <IoMdSpeedometer className='icon icons'/>
              <span className='smallText'>Dashboard</span>
            </a>
          </li>
          <li className='listItem'>
            <a href="#" className='menuLink flex'onClick={(e) => handleClick(e, 'MyInterns')}>
              <IoPeopleCircleSharp className='icon icons'/>
              <span className='smallText'>Interns</span>
            </a>
          </li>
          <li className='listItem'>
            <a href="#" className='menuLink flex' onClick={(e) => handleClick(e, 'MyTeams')}>
              <FaPeopleCarry className='icon icons'/>
              <span className='smallText'>My Teams</span>
            </a>
          </li>
          <li className='listItem'>
            <a href="#" className='menuLink flex'onClick={(e) => handleClick(e, 'MyProjects')}>
              <FaCircleNodes className='icon icons'/>
              <span className='smallText'>Projects</span>
            </a>
          </li>
          <li className='listItem'>
             <a href="#" className='menuLink flex' onClick={(e) => handleClick(e, 'EmployeeReports')}>
             <FaFileAlt className='icon icons'/>
      ...
      <div className='settingsDiv'>
        ...
        <ul className='menuLists grid'>
          <li className='listItem'>
            <a href="#" className='menuLink flex' onClick={(e) => handleClick(e, 'ChatEmployee')}>
          ...
          <li className='listItem'>
            <a href="#" className='menuLink flex'onClick={(e) => handleClick(e, 'EmployeeProfile')}>
  ...
  return (
    <div className='dashboard'>
      ...
      <div className='dashboardContainer'>
        <SidebarStag setActiveView={setActiveView} setShowLogoutConfirmation={setShowLogoutConfirmation} />
        <ul>
